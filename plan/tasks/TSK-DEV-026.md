# TSK-DEV-026 — Endpoint público verificação certificado
...
| **US** | [US-E05-005](../user-stories/E05-avaliacao-certificados/US-E05-005/US-E05-005.md) |
| **Épico** | E05 |

## Objetivo

Implementar **DEV-026** conforme `plan/features/epic-*.md` e SPEC correspondente.

## Escopo

Ver detalhe técnico no ficheiro `plan/features/registro-de-features.md` e épico **E05**.
