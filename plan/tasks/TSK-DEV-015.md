...
| **US** | [US-E03-004](../user-stories/E03-stripe-pagamentos/US-E03-004/US-E03-004.md) |
| **Épico** | E03 |

## Objetivo

Implementar **DEV-015** conforme `plan/features/epic-*.md` e SPEC correspondente.

## Escopo

Ver detalhe técnico no ficheiro `plan/features/registro-de-features.md` e épico **E03**.
