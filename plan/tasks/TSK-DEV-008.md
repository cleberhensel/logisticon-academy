...
| **US** | [US-E02-001](../user-stories/E02-catalogo-pedidos/US-E02-001/US-E02-001.md) |
| **Épico** | E02 |

## Objetivo

Implementar **DEV-008** conforme `plan/features/epic-*.md` e SPEC correspondente.

## Escopo

Ver detalhe técnico no ficheiro `plan/features/registro-de-features.md` e épico **E02**.
