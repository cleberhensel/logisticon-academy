...
| **US** | [US-E01-005](../user-stories/E01-identidade-acesso/US-E01-005/US-E01-005.md) |
| **Épico** | E01 |

## Objetivo

Implementar **DEV-005** conforme `plan/features/epic-*.md` e SPEC correspondente.

## Escopo

Ver detalhe técnico no ficheiro `plan/features/registro-de-features.md` e épico **E01**.
