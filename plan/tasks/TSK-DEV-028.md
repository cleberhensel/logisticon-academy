...
| **US** | [US-E06-001](../user-stories/E06-backoffice/US-E06-001/US-E06-001.md) |
| **Épico** | E06 |

## Objetivo

Implementar **DEV-028** conforme `plan/features/epic-*.md` e SPEC correspondente.

## Escopo

Ver detalhe técnico no ficheiro `plan/features/registro-de-features.md` e épico **E06**.
